...
INSERT INTO `gymnasium`.`orders` (`USERID`, `PRODUCT_NAMES`, `STATUS_O`, `TOTAL`, `CREATED`) VALUES (1, 'Hạt chia đen x 1', 'Đang ship', '6.274.000đ', 'May 12,2020');

INSERT INTO `gymnasium`.`orders` (`USERID`, `PRODUCT_NAMES`, `STATUS_O`, `TOTAL`, `CREATED`) VALUES (1, 'Nui Gạo Lứt x 1', 'Đang xử lý', '6.375.000đ', 'May 11,2020');