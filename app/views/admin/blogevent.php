...
$i = $start;
$res = array();
while ($i < $start + $perpage && $i < count($data['events'])) {
    array_push($res, $data['events'][$i]);
    $i++;
}
?>
        ...
        while ($i < count($res)){
            ...
            <div class='row d-flex justify-content-center'>
                <div class='col-lg-6 col-12'>
                    <a href='".URL_ROOT."/admin/events/".$res[$i]->ID."'><button class='btn btn-success' style='background-color: #1cc88a !important; border-color: #1cc88a !important' name='requestedit'>Sửa<i class='bi bi-pencil-square'></i></button></a>
                </div>
                <div class='col-lg-6 col-12'>
                    <form method='POST'>
